...
$kueri1 = mysqli_query($db, "SELECT * FROM pengguna");
    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 badge-dark mt-1 mpr-3 pt-4">
            <ul class="nav flex-column ml-2">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="pesanan.php"><i class="fas fa-money-check-alt"></i> Daftar Pesanan</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="laporan.php"><i class="fas fa-chart-bar"></i> Bukti Pembayaran</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-10 p-4">
            <h3><i class="fas fa-tachometer-alt mrss-2"></i> DASHBOARD</h3>
            <hr>
            <div class="row text-white">
                <div class="card bg-info ml-3" style="width:18rem;">
                    <div class="card-body">
                        ...
                        <div class="display-4"><?php echo "" . $cont1;
                        ?> </div>
                        <a href="user.php">
                            <p class="card-text text-white ">Lihat Detail <i class="fas fa-angle-double-right"></i>
                            </p>
                        </a>
                    </div>
                </div>
                ...
                <div class="card bg-success ml-3" style="width:18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="display-4"><?php echo "" . $cont;
                        ?></div>
                        <a href="paket.php">
