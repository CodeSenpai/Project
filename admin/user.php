<?php 
require '../config.php';
$user = mysqli_query($db,"SELECT * FROM pengguna");
$i = 1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-4 pt-2 mt-2">

            <h3><i class="fas fa-user-alt mr-2"></i> Daftar Pelanggan</h3>
            <br>
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row["alamat"]; ?></td>
                        <td align="center">
                            <button class="btn btn-info mr-1"><i class="fa fa-edit"></i> Edit</button>
                            <button class="btn btn-warning mr-1"><i class="fas fa-redo-alt"></i> Reset</button>
                            <button class="btn btn-danger mr-1"><i class="fa fa-trash-alt"></i> Delete</button>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endwhile; ?>
