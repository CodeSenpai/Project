...
<div class = "content mr-1">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head">
                  <div class="pull-left title">Bukti Pemesanan</div>
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    <div class="alert alert-success">
                      <b>Pengingat: Harap cetak ringkasan pemesanan Anda dan catat kode pemesanan Anda untuk pertanyaan pemesanan.</b>
                    </div>

                    <h3 style="text-align:center">Tika Catering Services</h3>
<h4 style="text-align:center">Jalan Selamat No. 153 Medan Amplas </h4>
<h4 style="text-align:center">Tel. No. : 435-00787</h4>
<h4 style="text-align:center">Email : info@tikacatering.com</h4>
<hr>
</body>
</html>